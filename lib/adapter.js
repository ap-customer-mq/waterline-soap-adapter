...
function buildRequest(soapAction, args) {
    if (soapAction.defaultParameters) args = _.merge(soapAction.defaultParameters, args);
      ...
      soap.createClient(wsdlUrl, function(err, client) {
        ...
        executeCallbacks(model, 'before', actionName, callbackOpts, function() {
          soapMethod(request, function(err, result, body, header) {
            ...
            callbackOpts.responseBody = body;
            callbackOpts.responseHeaders = header;
            callbackOpts.mappedResponse = mappedResponse;
